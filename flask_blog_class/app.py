...
def create():
    ...
    if request.method == 'POST':
        ...
        #else make a database connection and insert the content
        if not title:
...
# create a route to edit a post. Load page witht he get or post method
# pass the post ID as url perameter 
...
def edit(id): 
    ...
    #if POst the process the form data. get data and validate it. update the post and redirect to the home page
    if request.method == 'POST':
